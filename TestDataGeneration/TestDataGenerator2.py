...
tk.Label(root, text="Total Transactions:").grid(row=2, column=0, padx=10, pady=5, sticky="e")
total_transactions = tk.Entry(root)
total_transactions.grid(row=2, column=1, padx=10, pady=5, sticky="w")

tk.Label(root, text="Number of SUCCESS Transactions:").grid(row=3, column=0, padx=10, pady=5, sticky="e")
success_count = tk.Entry(root)
success_count.grid(row=3, column=1, padx=10, pady=5, sticky="w")

tk.Label(root, text="Number of REFUND Transactions:").grid(row=4, column=0, padx=10, pady=5, sticky="e")
refund_count = tk.Entry(root)
refund_count.grid(row=4, column=1, padx=10, pady=5, sticky="w")

tk.Label(root, text="Number of FAILED Transactions:").grid(row=5, column=0, padx=10, pady=5, sticky="e")
failed_count = tk.Entry(root)
failed_count.grid(row=5, column=1, padx=10, pady=5, sticky="w")

tk.Label(root, text="Biller OUID : ").grid(row=6, column=0, padx=10, pady=5, sticky="e")
BillerOuid = tk.Entry(root)
BillerOuid.grid(row=6, column=1, padx=10, pady=5, sticky="w")

tk.Label(root, text="Output Folder:").grid(row=7, column=0, padx=10, pady=5, sticky="e")
folder_label = tk.Label(root, text="Select Folder", anchor="w", width=30)
folder_label.grid(row=7, column=1, padx=10, pady=5, sticky="w")
tk.Button(root, text="Select Folder", command=select_folder).grid(row=7, column=2, padx=10, pady=5)

tk.Button(root, text="Generate", command=generate_transactions).grid(row=8, column=0, columnspan=2, pady=10)
tk.Button(root, text="Display Count", command=display_count).grid(row=8, column=2, pady=10)
