...
tk.Label(root, text="Output Folder:").grid(row=6, column=0, padx=10, pady=5, sticky="e")
folder_label = tk.Label(root, text="Select Folder", anchor="w", width=30)
folder_label.grid(row=6, column=1, padx=10, pady=5, sticky="w")
tk.Button(root, text="Select Folder", command=select_folder).grid(row=6, column=2, padx=10, pady=5)

tk.Button(root, text="Generate", command=generate_transactions).grid(row=7, column=0, columnspan=2, pady=10)
tk.Button(root, text="Display Count", command=display_count).grid(row=7, column=2, pady=10)
